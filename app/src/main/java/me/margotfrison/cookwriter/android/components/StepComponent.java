...
@Getter
public class StepComponent extends LinearLayout implements View.OnClickListener {
    private int index;
    ...
    public StepComponent(Context context, int index, String stepDescription, StepListener listener) {
        super(context);
        inflate(context, R.layout.component_step, this);
